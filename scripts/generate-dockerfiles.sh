...
#!/bin/sh
# This file is automatically generated, if you want to customize it,
# add .override at the end of the filename and restart the build process.
# The original will always be regenerated so you can watch the difference.
...
EOM
if [ -f "${PROJECTSPACEPIPEDIR}/rebuild.sh.override" ]; then
  cp ${PROJECTSPACEPIPEDIR}/rebuild.sh.override $BUILDDIR/build-alpine/alpinebuild.sh
else
...
CMD /alpinebuild.sh
EOM
if [ -f "${PROJECTSPACEPIPEDIR}/Dockerfile-rebuild.override" ]; then
  cp ${PROJECTSPACEPIPEDIR}/Dockerfile-rebuild.override ${BUILDDIR}/build-alpine/Dockerfile
else
...
EOM
if [ -f "${PROJECTSPACEPIPEDIR}/Dockerfile-runtime.override" ]; then
  cp ${PROJECTSPACEPIPEDIR}/Dockerfile-runtime.override ${BUILDDIR}/bundle-alpine/Dockerfile
else
